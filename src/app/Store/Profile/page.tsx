...
//                   className="flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-xl hover:bg-green-700 cursor-pointer"
//                 >
//                   <Plus size={18} />
//                   Add Address
//                 </button>
...
//                       <div
//                         key={item._id}
//                         //   className="border rounded-2xl p-4 flex justify-between items-start bg-white shadow-sm"
//                         className="border rounded-2xl p-4 flex justify-between items-start bg-white shadow-sm 
...
//                             className="p-2 bg-gray-100 rounded-lg cursor-pointer transition-all duration-200 hover:bg-blue-100 hover:text-blue-600 hover:scale-105"
//                           >
//                             <Pencil size={16} />
//                           </button>
...
//                             className="p-2 bg-gray-100 rounded-lg hover:bg-red-100 hover:text-red-600 transition cursor-pointer"
//                           >
//                             <Trash2 size={16} />
//                           </button>
//                         </div>
...
//     {/* CARD */}
//     <div className="bg-white p-6 rounded-2xl shadow-sm border w-full  space-y-5">
