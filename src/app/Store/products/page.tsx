...
//           {" "}
//           <HeaderBanner
//             title={category?.name ?? brand?.name ?? "All Products"}
//             subtitle={
//               category
...
//                 <button
//                   onClick={() =>
//                     router.push(brandId ? "/Store/brands" : "/Store/categories")
//                   }
...
//                 <button
//                   className="w-8 h-8 bg-white rounded-full shadow flex items-center justify-center hover:text-green-600 hover:scale-110 transition cursor-pointer"
//                   onClick={() => router.push(`/Store/products/${product._id}`)}
//                 >
//                   <Eye size={16} />
//                 </button>
